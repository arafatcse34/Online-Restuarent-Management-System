...
$con=mysqli_connect('localhost','root','','rms') or die ("unable to connect");
    if(isset($_POST['Submit'])){
		...
		$sqll="SELECT * FROM food_details WHERE food_category='$id'";
        $result=mysqli_query($con,$sql);
...
<?php
    ...
    $quantities=mysqli_query($con,$sql);
...
<?php
    ...
    $flag_0 = 0;
	$sql="SELECT * FROM cart_details WHERE member_id='$member_id' AND flag='$flag_0'";
