...
$l= "SELECT * FROM quantities";
$quantities=mysqli_query($con,$l);

//retrieve currencies from the currencies table (deleting)
$o="SELECT * FROM currencies";
$currencies=mysqli_query($con,$o);


//retrieve currencies from the currencies table (updating)
$t="SELECT * FROM currencies";
$currencies_1=mysqli_query($con,$t);


//retrieve polls from the ratings table
$x="SELECT * FROM ratings";
$ratings=mysqli_query($con,$x);


//retrieve timezones from the timezones table (deleting)
$z="SELECT * FROM timezones";
$timezones=mysqli_query($con,$z);


//retrieve timezones from the timezones table (updating)
$z="SELECT * FROM timezones";
$timezones_1=mysqli_query($con,$z);
 

//retrieve tables from the tables table
$j="SELECT * FROM tables";
$tables=mysqli_query($con,$j);


//retrieve partyhalls from the partyhalls table
$u="SELECT * FROM partyhalls";
$partyhalls=mysqli_query($con,$u);


//retrieve questions from the questions table
$h="SELECT * FROM questions";
$questions=mysqli_query($con,$h);
